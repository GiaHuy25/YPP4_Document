...
VALUES
  ...
  GO
-- STEP 3: Create Table customer_nodes--
CREATE TABLE customer_nodes(
  ...
  start_date DATE,
  end_date DATE
  CONSTRAINT PK_customer_id PRIMARY KEY (row_id, customer_id )
  constraint fk_nodes_regions foreign key (region_id) references regions (region_id)
);
GO
-- Insert new records in table--
...
WITH deposits AS (
  SELECT 
    ...
    AVG(cast(txn_amount as int)) AS avg_amount
  FROM customer_transactions
